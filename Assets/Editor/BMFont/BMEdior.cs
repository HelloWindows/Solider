...
namespace CustomEditor {
    public class BMEdior {
        [MenuItem("Custom Editor/BMFont/Create Font", true)]
        private static bool CheckCreateFont() {
        ...
        [MenuItem("Custom Editor/BMFont/Create Font", false, 10)]
