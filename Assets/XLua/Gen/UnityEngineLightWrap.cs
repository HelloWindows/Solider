...
namespace XLua.CSObjectWrap
{
    ...
    public class UnityEngineLightWrap 
    {
        public static void __Register(RealStatePtr L)
        {
            ...
            Utils.RegisterFunc(L, Utils.GETTER_IDX, "lightmappingMode", _g_get_lightmappingMode);
            ...
            Utils.RegisterFunc(L, Utils.SETTER_IDX, "lightmappingMode", _s_set_lightmappingMode);
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _g_get_lightmappingMode(RealStatePtr L)
        {
		    try {
                ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			
                UnityEngine.Light gen_to_be_invoked = (UnityEngine.Light)translator.FastGetCSObj(L, 1);
                translator.Push(L, gen_to_be_invoked.lightmappingMode);
            } catch(System.Exception gen_e) {
                return LuaAPI.luaL_error(L, "c# exception:" + gen_e);
            }
            return 1;
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _s_set_lightmappingMode(RealStatePtr L)
        {
		    try {
                ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			
                UnityEngine.Light gen_to_be_invoked = (UnityEngine.Light)translator.FastGetCSObj(L, 1);
                UnityEngine.LightmappingMode gen_value;translator.Get(L, 2, out gen_value);
				gen_to_be_invoked.lightmappingMode = gen_value;
