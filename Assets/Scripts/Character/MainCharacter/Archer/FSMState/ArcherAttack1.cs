...
namespace Solider {
    namespace Character {
        namespace MainCharacter {
            public class ArcherAttack1 : ICharacterState {
                ...
                public ArcherAttack1(IMainCharacter mainCharacter) {
                    this.mainCharacter = mainCharacter;
                    caromState = new ArcherAttack2(mainCharacter);
                } // end ArcherAttack1
