/*******************************************************************
 * FileName: HeroCharacterSurface.cs
 * Author: Yogi
 * Creat Date:
...
namespace Solider {
    namespace Character {
        namespace Hero {
            public class HeroCharacterSurface : IHeroCharacterSurface {
                ...
                public HeroCharacterSurface(Transform wingTrans, Transform liftTrans, Transform furlTrans, SkinnedMeshRenderer renderer) {
            ...
            } // end class HeroCharacterSurface
        } // end namespace Hero 
